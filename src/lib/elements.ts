...
export const checkBox = (...decorators: HTMLProps) => element("input", attribute("type", "checkbox"), ...decorators)()
export const radioButton = (...decorators: HTMLProps) => element("input", attribute("type", "radio"), ...decorators)()
export const textField = (...decorators: HTMLProps) => element("input", attribute("type", "text"), ...decorators)()
export const submit = (...decorators: HTMLProps) => element("input", attribute("type", "submit"), ...decorators)()
export const image = (...decorators: HTMLProps) => element("image", attribute("type", "image"), ...decorators)()
export const reset = (...decorators: HTMLProps) => element("input", attribute("type", "reset"), ...decorators)()
export const email = (...decorators: HTMLProps) => element("input", attribute("type", "email"), ...decorators)()
export const url = (...decorators: HTMLProps) => element("input", attribute("type", "url"), ...decorators)()
export const number = (...decorators: HTMLProps) => element("input", attribute("type", "number"), ...decorators)()
export const range = (...decorators: HTMLProps) => element("input", attribute("type", "range"), ...decorators)()
export const dateTimeLocal = (...decorators: HTMLProps) => element("input", attribute("type", "datetime-local"), ...decorators)()
export const date = (...decorators: HTMLProps) => element("input", attribute("type", "date"), ...decorators)()
export const monthField = (...decorators: HTMLProps) => element("input", attribute("type", "month"), ...decorators)()
export const weekField = (...decorators: HTMLProps) => element("input", attribute("type", "week"), ...decorators)()
export const timeField = (...decorators: HTMLProps) => element("input", attribute("type", "time"), ...decorators)()
export const searchField = (...decorators: HTMLProps) => element("input", attribute("type", "search"), ...decorators)()
export const tel = (...decorators: HTMLProps) => element("input", attribute("type", "tel"), ...decorators)()
export const color = (...decorators: HTMLProps) => element("input", attribute("type", "color"), ...decorators)()
export const file = (...decorators: HTMLProps) => element("input", attribute("type", "file"), ...decorators)()
export const password = (...decorators: HTMLProps) => element("input", attribute("type", "password"), ...decorators)()
